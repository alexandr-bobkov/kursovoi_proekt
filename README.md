...
yandex_coursework/            # Корневая папка вашего дипломного проекта
│
├── terraform/                # Каталог управления облачной инфраструктурой
│   ├── providers.tf          # Подключение и авторизация провайдера Yandex Cloud
